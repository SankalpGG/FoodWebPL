Food Web Pl
The main and complete version of the program is stored in file named pl.py and the database replica is stored in folder named DB containing the data from server
